(define (problem mate-in-one)
  ...
  (:init
    ...
    ;; === Attacked squares and attacked_by facts ===
    ...
    ;; Define board relations same_file                   
    ...
    ;; Symmetric same_rank relations (horizontal)
    ...
    ;; Define adjacent squares (king moves)
